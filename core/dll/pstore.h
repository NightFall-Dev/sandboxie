...
extern "C"
{
	...
	typedef struct IEnumPStoreItemsVtbl
	{
		...
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(IEnumPStoreItems* This,
		    /* [in] */ REFIID riid,
		    /* [iid_is][out] */ void** ppvObject);

		ULONG(STDMETHODCALLTYPE* AddRef)(IEnumPStoreItems* This);

		ULONG(STDMETHODCALLTYPE* Release)(IEnumPStoreItems* This);

		HRESULT(STDMETHODCALLTYPE* Next)(IEnumPStoreItems* This,
		    /* [in] */ DWORD celt,
		    /* [in] */ LPWSTR* rgelt,
		    /* [in] */ DWORD* pceltFetched);

		HRESULT(STDMETHODCALLTYPE* Skip)(IEnumPStoreItems* This,
		    /* [in] */ DWORD celt);

		HRESULT(STDMETHODCALLTYPE* Reset)(IEnumPStoreItems* This);

		HRESULT(STDMETHODCALLTYPE* Clone)(IEnumPStoreItems* This,
	...
	HRESULT STDMETHODCALLTYPE IEnumPStoreItems_Next_Proxy(IEnumPStoreItems* This,
	    /* [in] */ DWORD celt,
	    /* [in] */ LPWSTR* rgelt,
	    /* [in] */ DWORD* pceltFetched);
	...
	HRESULT STDMETHODCALLTYPE IEnumPStoreItems_Skip_Proxy(IEnumPStoreItems* This,
	    /* [in] */ DWORD celt);
	...
	HRESULT STDMETHODCALLTYPE IEnumPStoreItems_Reset_Proxy(IEnumPStoreItems* This);
	...
	HRESULT STDMETHODCALLTYPE IEnumPStoreItems_Clone_Proxy(IEnumPStoreItems* This,
	    /* [in] */ IEnumPStoreItems** ppenum);
	...
	typedef struct IEnumPStoreTypesVtbl
	{
		...
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(IEnumPStoreTypes* This,
		    /* [in] */ REFIID riid,
		    /* [iid_is][out] */ void** ppvObject);

		ULONG(STDMETHODCALLTYPE* AddRef)(IEnumPStoreTypes* This);

		ULONG(STDMETHODCALLTYPE* Release)(IEnumPStoreTypes* This);

		HRESULT(STDMETHODCALLTYPE* Next)(IEnumPStoreTypes* This,
		    /* [in] */ DWORD celt,
		    /* [in] */ GUID* rgelt,
		    /* [in] */ DWORD* pceltFetched);

		HRESULT(STDMETHODCALLTYPE* Skip)(IEnumPStoreTypes* This,
		    /* [in] */ DWORD celt);

		HRESULT(STDMETHODCALLTYPE* Reset)(IEnumPStoreTypes* This);

		HRESULT(STDMETHODCALLTYPE* Clone)(IEnumPStoreTypes* This,
	...
	HRESULT STDMETHODCALLTYPE IEnumPStoreTypes_Next_Proxy(IEnumPStoreTypes* This,
	    /* [in] */ DWORD celt,
	    /* [in] */ GUID* rgelt,
	    /* [in] */ DWORD* pceltFetched);
	...
	HRESULT STDMETHODCALLTYPE IEnumPStoreTypes_Skip_Proxy(IEnumPStoreTypes* This,
	    /* [in] */ DWORD celt);
	...
	HRESULT STDMETHODCALLTYPE IEnumPStoreTypes_Reset_Proxy(IEnumPStoreTypes* This);
	...
	HRESULT STDMETHODCALLTYPE IEnumPStoreTypes_Clone_Proxy(IEnumPStoreTypes* This,
	    /* [in] */ IEnumPStoreTypes** ppenum);
	...
	typedef struct IPStoreVtbl
	{
		...
		HRESULT(STDMETHODCALLTYPE* QueryInterface)(IPStore* This,
		    /* [in] */ REFIID riid,
		    /* [iid_is][out] */ void** ppvObject);

		ULONG(STDMETHODCALLTYPE* AddRef)(IPStore* This);

		ULONG(STDMETHODCALLTYPE* Release)(IPStore* This);

		HRESULT(STDMETHODCALLTYPE* GetInfo)(IPStore* This,
		    /* [in] */ PPST_PROVIDERINFO* ppProperties);

		HRESULT(STDMETHODCALLTYPE* GetProvParam)(IPStore* This,
		    /* [in] */ DWORD dwParam,
		    /* [out] */ DWORD* pcbData,
		    /* [out] */ BYTE** ppbData,
		    /* [in] */ DWORD dwFlags);

		HRESULT(STDMETHODCALLTYPE* SetProvParam)(IPStore* This,
		    /* [in] */ DWORD dwParam,
		    /* [in] */ DWORD cbData,
		    /* [in] */ BYTE* pbData,
		    /* [in] */ DWORD* dwFlags);

		HRESULT(STDMETHODCALLTYPE* CreateType)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ PPST_TYPEINFO pInfo,
		    /* [in] */ DWORD dwFlags);

		HRESULT(STDMETHODCALLTYPE* GetTypeInfo)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ PPST_TYPEINFO** ppInfo,
		    /* [in] */ DWORD dwFlags);

		HRESULT(STDMETHODCALLTYPE* DeleteType)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ DWORD dwFlags);

		HRESULT(STDMETHODCALLTYPE* CreateSubtype)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ const GUID* pSubtype,
		    /* [in] */ PPST_TYPEINFO pInfo,
		...
		HRESULT(STDMETHODCALLTYPE* GetSubtypeInfo)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ const GUID* pSubtype,
		    /* [in] */ PPST_TYPEINFO** ppInfo,
		...
		HRESULT(STDMETHODCALLTYPE* DeleteSubtype)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ const GUID* pSubtype,
		    /* [in] */ DWORD dwFlags);

		HRESULT(STDMETHODCALLTYPE* ReadAccessRuleset)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ const GUID* pSubtype,
		    /* [in] */ PPST_TYPEINFO pInfo,
		...
		HRESULT(STDMETHODCALLTYPE* WriteAccessRuleset)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ const GUID* pSubtype,
		    /* [in] */ PPST_TYPEINFO pInfo,
		...
		HRESULT(STDMETHODCALLTYPE* EnumTypes)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ DWORD dwFlags,
		    /* [in] */ IEnumPStoreTypes** ppenum);

		HRESULT(STDMETHODCALLTYPE* EnumSubtypes)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pType,
		    /* [in] */ DWORD dwFlags,
		    /* [in] */ IEnumPStoreTypes** ppenum);

		HRESULT(STDMETHODCALLTYPE* DeleteItem)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pItemType,
		    /* [in] */ const GUID* pItemSubType,
		    /* [in] */ LPCWSTR szItemName,
		...
		HRESULT(STDMETHODCALLTYPE* ReadItem)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pItemType,
		    /* [in] */ const GUID* pItemSubtype,
		    /* [in] */ LPCWSTR szItemName,
		...
		HRESULT(STDMETHODCALLTYPE* WriteItem)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pItemType,
		    /* [in] */ const GUID* pItemSubtype,
		    /* [in] */ LPCWSTR szItemName,
		...
		HRESULT(STDMETHODCALLTYPE* OpenItem)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pItemType,
		    /* [in] */ const GUID* pItemSubtype,
		    /* [in] */ LPCWSTR szItemName,
		...
		HRESULT(STDMETHODCALLTYPE* CloseItem)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pItemType,
		    /* [in] */ const GUID* pItemSubtype,
		    /* [in] */ LPCWSTR* szItemName,
		...
		HRESULT(STDMETHODCALLTYPE* EnumItems)(IPStore* This,
		    /* [in] */ PST_KEY Key,
		    /* [in] */ const GUID* pItemType,
		    /* [in] */ const GUID* pItemSubtype,
		    /* [in] */ DWORD dwFlags,
	...
	HRESULT STDMETHODCALLTYPE IPStore_GetInfo_Proxy(IPStore* This,
	    /* [in] */ PPST_PROVIDERINFO* ppProperties);
	...
	HRESULT STDMETHODCALLTYPE IPStore_GetProvParam_Proxy(IPStore* This,
	    /* [in] */ DWORD dwParam,
	    /* [out] */ DWORD* pcbData,
	    /* [out] */ BYTE** ppbData,
	    /* [in] */ DWORD dwFlags);
	...
	HRESULT STDMETHODCALLTYPE IPStore_SetProvParam_Proxy(IPStore* This,
	    /* [in] */ DWORD dwParam,
	    /* [in] */ DWORD cbData,
	    /* [in] */ BYTE* pbData,
	    /* [in] */ DWORD* dwFlags);
	...
	HRESULT STDMETHODCALLTYPE IPStore_CreateType_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ PPST_TYPEINFO pInfo,
	    /* [in] */ DWORD dwFlags);
	...
	HRESULT STDMETHODCALLTYPE IPStore_GetTypeInfo_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ PPST_TYPEINFO** ppInfo,
	    /* [in] */ DWORD dwFlags);
	...
	HRESULT STDMETHODCALLTYPE IPStore_DeleteType_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ DWORD dwFlags);
	...
	HRESULT STDMETHODCALLTYPE IPStore_CreateSubtype_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ const GUID* pSubtype,
	    /* [in] */ PPST_TYPEINFO pInfo,
	...
	HRESULT STDMETHODCALLTYPE IPStore_GetSubtypeInfo_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ const GUID* pSubtype,
	    /* [in] */ PPST_TYPEINFO** ppInfo,
	...
	HRESULT STDMETHODCALLTYPE IPStore_DeleteSubtype_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ const GUID* pSubtype,
	    /* [in] */ DWORD dwFlags);
	...
	HRESULT STDMETHODCALLTYPE IPStore_ReadAccessRuleset_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ const GUID* pSubtype,
	    /* [in] */ PPST_TYPEINFO pInfo,
	...
	HRESULT STDMETHODCALLTYPE IPStore_WriteAccessRuleset_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ const GUID* pSubtype,
	    /* [in] */ PPST_TYPEINFO pInfo,
	...
	HRESULT STDMETHODCALLTYPE IPStore_EnumTypes_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ DWORD dwFlags,
	    /* [in] */ IEnumPStoreTypes** ppenum);
	...
	HRESULT STDMETHODCALLTYPE IPStore_EnumSubtypes_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pType,
	    /* [in] */ DWORD dwFlags,
	    /* [in] */ IEnumPStoreTypes** ppenum);
	...
	HRESULT STDMETHODCALLTYPE IPStore_DeleteItem_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pItemType,
	    /* [in] */ const GUID* pItemSubType,
	    /* [in] */ LPCWSTR szItemName,
	...
	HRESULT STDMETHODCALLTYPE IPStore_ReadItem_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pItemType,
	    /* [in] */ const GUID* pItemSubtype,
	    /* [in] */ LPCWSTR szItemName,
	...
	HRESULT STDMETHODCALLTYPE IPStore_WriteItem_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pItemType,
	    /* [in] */ const GUID* pItemSubtype,
	    /* [in] */ LPCWSTR szItemName,
	...
	HRESULT STDMETHODCALLTYPE IPStore_OpenItem_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pItemType,
	    /* [in] */ const GUID* pItemSubtype,
	    /* [in] */ LPCWSTR szItemName,
	...
	HRESULT STDMETHODCALLTYPE IPStore_CloseItem_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pItemType,
	    /* [in] */ const GUID* pItemSubtype,
	    /* [in] */ LPCWSTR* szItemName,
	...
	HRESULT STDMETHODCALLTYPE IPStore_EnumItems_Proxy(IPStore* This,
	    /* [in] */ PST_KEY Key,
	    /* [in] */ const GUID* pItemType,
	    /* [in] */ const GUID* pItemSubtype,
	    /* [in] */ DWORD dwFlags,
