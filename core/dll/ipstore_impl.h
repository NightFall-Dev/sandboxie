...
private:
	...
	PsType* create_type(const GUID* pType, const PST_TYPEINFO* pInfo, DWORD dwFlags);
	PsSubtype* create_subtype(PsType* type, const GUID* pSubtype, const PST_TYPEINFO* pInfo, DWORD dwFlags);
	PsItem* create_item(PsSubtype* subtype, PsItem* item, const WCHAR* szItemName, DWORD cbData, void* pbData);
