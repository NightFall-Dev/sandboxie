...
static void Log_Event_Msg(NTSTATUS error_code, const WCHAR* string1, const WCHAR* string2);

static void Log_Popup_Msg_2(NTSTATUS error_code, const WCHAR* string1, ULONG string1_len, const WCHAR* string2, ULONG string2_len, ULONG session_id);
...
_FX void Log_Event_Msg(NTSTATUS error_code, const WCHAR* string1, const WCHAR* string2)
{
	int entry_size;
	int string1_len = 0;
	int string2_len = 0;
	...
	{
		IO_ERROR_LOG_PACKET* entry = (IO_ERROR_LOG_PACKET*)IoAllocateErrorLogEntry(Driver_Object, (UCHAR)entry_size);
...
_FX void Log_Popup_Msg(NTSTATUS error_code, const WCHAR* string1, const WCHAR* string2, ULONG session_id)
{
	...
	Log_Popup_Msg_2(error_code, string1, string1_len, string2, string2_len, session_id);

	//
	// log message to SbieSvc and trigger SbieSvc to wake up and collect it
	//

	Log_Popup_Msg_2(error_code, string1, string1_len, string2, string2_len, -1);
...
_FX void Log_Popup_Msg_2(NTSTATUS error_code, const WCHAR* string1, ULONG string1_len, const WCHAR* string2, ULONG string2_len, ULONG session_id)
{
	API_WORK_ITEM* work_item;
	ULONG length;
	WCHAR* ptr;

	length = sizeof(API_WORK_ITEM) + sizeof(ULONG) // msgid
	    + (string1_len + 1) * sizeof(WCHAR) + (string2_len + 1) * sizeof(WCHAR);
...
_FX void Log_Msg(NTSTATUS error_code, const WCHAR* string1, const WCHAR* string2)
{
...
_FX void Log_Msg_Session(NTSTATUS error_code, const WCHAR* string1, const WCHAR* string2, ULONG session_id)
{
...
_FX void Log_Status_Ex(NTSTATUS error_code, ULONG error_subcode, NTSTATUS nt_status, const WCHAR* string2)
{
...
_FX void Log_Status_Ex_Session(NTSTATUS error_code, ULONG error_subcode, NTSTATUS nt_status, const WCHAR* string2, ULONG session_id)
{
	WCHAR str[100];
