...
void Log_Popup_Msg(NTSTATUS error_code, const WCHAR* string1, const WCHAR* string2, ULONG session_id);

void Log_Status_Ex(NTSTATUS error_code, ULONG error_subcode, NTSTATUS nt_status, const WCHAR* string2 OPTIONAL);

void Log_Status_Ex_Session(NTSTATUS error_code, ULONG error_subcode, NTSTATUS nt_status, const WCHAR* string2 OPTIONAL, ULONG session_id);

#define Log_Msg0(error_code) Log_Msg(error_code, NULL, NULL)

#define Log_Msg1(error_code, str1) Log_Msg(error_code, str1, NULL)

#define Log_Msg2(error_code, str1, str2) Log_Msg(error_code, str1, str2)

#define Log_Status(error_code, error_subcode, ntstatus) Log_Status_Ex(error_code, error_subcode, ntstatus, NULL)
