...
void RestartHostInjectedSvcs()
{
	...
	BOOL b = EnumServicesStatusExW(hScm, SC_ENUM_PROCESS_INFO, SERVICE_WIN32, SERVICE_ACTIVE, pProcBuf, dwProcBufSize, &dwBytesNeeded, &dwServicesReturned, &dwResumeHandle, NULL);
