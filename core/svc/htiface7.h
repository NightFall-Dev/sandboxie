...
typedef struct IUriVtbl
{
	...
	HRESULT(STDMETHODCALLTYPE* QueryInterface)(IUri* This,
	    /* [in] */ REFIID riid,
	...
	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetPropertyBSTR)(IUri* This,
	    /* [range][in] */ Uri_PROPERTY uriProp,
	    /* [out] */ BSTR* pbstrProperty,
	    /* [in] */ DWORD dwFlags);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetPropertyLength)(IUri* This,
	    /* [range][in] */ Uri_PROPERTY uriProp,
	    /* [out] */ DWORD* pcchProperty,
	    /* [in] */ DWORD dwFlags);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetPropertyDWORD)(IUri* This,
	    /* [range][in] */ Uri_PROPERTY uriProp,
	    /* [out] */ DWORD* pdwProperty,
	    /* [in] */ DWORD dwFlags);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* HasProperty)(IUri* This,
	    /* [range][in] */ Uri_PROPERTY uriProp,
	    /* [out] */ BOOL* pfHasProperty);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetAbsoluteUri)(IUri* This,
	    /* [out] */ BSTR* pbstrAbsoluteUri);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetAuthority)(IUri* This,
	    /* [out] */ BSTR* pbstrAuthority);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetDisplayUri)(IUri* This,
	    /* [out] */ BSTR* pbstrDisplayString);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetDomain)(IUri* This,
	    /* [out] */ BSTR* pbstrDomain);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetExtension)(IUri* This,
	    /* [out] */ BSTR* pbstrExtension);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetFragment)(IUri* This,
	    /* [out] */ BSTR* pbstrFragment);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetHost)(IUri* This,
	    /* [out] */ BSTR* pbstrHost);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetPassword)(IUri* This,
	    /* [out] */ BSTR* pbstrPassword);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetPath)(IUri* This,
	    /* [out] */ BSTR* pbstrPath);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetPathAndQuery)(IUri* This,
	    /* [out] */ BSTR* pbstrPathAndQuery);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetQuery)(IUri* This,
	    /* [out] */ BSTR* pbstrQuery);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetRawUri)(IUri* This,
	    /* [out] */ BSTR* pbstrRawUri);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetSchemeName)(IUri* This,
	    /* [out] */ BSTR* pbstrSchemeName);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetUserInfo)(IUri* This,
	    /* [out] */ BSTR* pbstrUserInfo);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetUserName)(IUri* This,
	    /* [out] */ BSTR* pbstrUserName);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetHostType)(IUri* This,
	    /* [out] */ DWORD* pdwHostType);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetPort)(IUri* This,
	    /* [out] */ DWORD* pdwPort);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetScheme)(IUri* This,
	    /* [out] */ DWORD* pdwScheme);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetZone)(IUri* This,
	    /* [out] */ DWORD* pdwZone);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* GetProperties)(IUri* This,
	    /* [out] */ LPDWORD pdwFlags);

	/* [helpstring] */ HRESULT(STDMETHODCALLTYPE* IsEqual)(IUri* This,
	    /* [in] */ IUri* pUri,
	    /* [out] */ BOOL* pfEqual);
