...
public:
	...
	void GetProcessList(WCHAR type, CStringList& list, BOOL withBrackets = FALSE);

	void GetProcessGroupsInBox(CStringList& names);

	void GetProcessGroupName(const CString& GroupName, CString& LocalGroupName, CString& GlobalGroupName);
	...
	void GetQuickRecoveryFolders(CStringList& list, BOOL withBrackets = FALSE);

	BOOL AddOrRemoveAutoRecoveryIgnores(const CString& item, BOOL add);
	void GetAutoRecoveryIgnores(CStringList& list, BOOL withBrackets = FALSE);
	...
	void GetXxxPathList(ULONG type, CStringList& list, BOOL withBrackets = FALSE);
	void GetXxxPathListForPgm(ULONG type, CStringList& list, const CString& pgm, BOOL withBrackets = FALSE);
	void SetXxxPathListForPgm(ULONG type, const CStringList& list, const CString& pgm);
	...
	static void GetSetUserAccounts(const CString& BoxName, BOOL set, CStringList& list);
