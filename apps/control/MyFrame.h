...
class CMyFrame : public CFrameWnd
{
	...
	void RemoveOrRename(CBox& box, BOOL remove, BOOL rename, bool* ReloadBoxes);
	void InitSandboxMenu(CMenu* pMenu, int posChild, int posInsert);
	void InitSandboxMenu1(void* _box_order, CMenu* ModelMenu, CMenu* SandboxMenu, int posInsert);
