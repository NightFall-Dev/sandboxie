...
protected:
	void CalculatePositionAndSize(void* _childobj, int w, int h, CPoint& out_pos, CSize& out_size);
...
public:
	...
	BOOL SetMinMaxChildObject(CWnd* wnd, const CSize& size_min, const CSize& size_max);

	CWnd* CreateChild(int ctrlid, const WCHAR* clsnm, ULONG exstyle, ULONG style, const CPoint& pos, const CSize& size);
...
protected:
	...
	static LRESULT LayoutCtrlWndClass(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam);
