...
static HRESULT IEServer_IOleCommandTarget_QueryStatus(IOleCommandTarget* This, const GUID* pguidCmdGroup, ULONG cCmds, OLECMD prgCmds[], OLECMDTEXT* pCmdText);
static HRESULT IEServer_IOleCommandTarget_Exec(IOleCommandTarget* This, const GUID* pguidCmdGroup, DWORD nCmdID, DWORD nCmdexecopt, VARIANT* pvaIn, VARIANT* pvaOut);


static HRESULT IEServer_ITargetFramePriv_FindFrameDownwards(ITargetFramePriv* This, LPCWSTR pszTargetName, DWORD dwFlags, IUnknown** ppunkTargetFrame);
static HRESULT IEServer_ITargetFramePriv_FindFrameInContext(ITargetFramePriv* This, LPCWSTR pszTargetName, IUnknown* punkContextFrame, DWORD dwFlags, IUnknown** ppunkTargetFrame);
static HRESULT IEServer_ITargetFramePriv_OnChildFrameActivate(ITargetFramePriv* This, IUnknown* pUnkChildFrame);
static HRESULT IEServer_ITargetFramePriv_OnChildFrameDeactivate(ITargetFramePriv* This, IUnknown* pUnkChildFrame);
static HRESULT IEServer_ITargetFramePriv_NavigateHack(ITargetFramePriv* This, DWORD grfHLNF, LPBC pbc, IBindStatusCallback* pibsc, LPCWSTR pszTargetName, LPCWSTR pszUrl, LPCWSTR pszLocation);
static HRESULT IEServer_ITargetFramePriv_FindBrowserByIndex(ITargetFramePriv* This, DWORD dwID, IUnknown** ppunkBrowser);
static HRESULT IEServer_ITargetFramePriv2_AggregatedNavigation2(ITargetFramePriv2* This, DWORD grfHLNF, LPBC pbc, IBindStatusCallback* pibsc, LPCWSTR pszTargetName, IUri* pUri, LPCWSTR pszLocation);

static HRESULT IEServer_IWebBrowser2_NotImpl(IWebBrowser2* This);
static HRESULT IEServer_IWebBrowser2_Navigate(IWebBrowser2* This, BSTR url, VARIANT* Flags, VARIANT* TargetFrameName, VARIANT* PostData, VARIANT* Headers);
static HRESULT IEServer_IWebBrowser2_put_Visible(IWebBrowser2* This, VARIANT_BOOL Value);
static HRESULT IEServer_IWebBrowser2_Navigate2(IWebBrowser2* This, VARIANT* URL, VARIANT* Flags, VARIANT* TargetFrameName, VARIANT* PostData, VARIANT* Headers);


static HRESULT IEServer_ITargetFrame2_NotImpl(ITargetFrame2* This);
static HRESULT IEServer_ITargetFrame2_SetFrameName(ITargetFrame2* This, LPCWSTR pszFrameName);
static HRESULT IEServer_ITargetFrame2_SetFrameSrc(ITargetFrame2* This, LPCWSTR pszFrameSrc);


static HRESULT IEServer_IHlinkFrame_NotImpl(IHlinkFrame* This);
static HRESULT IEServer_IHlinkFrame_Navigate(IHlinkFrame* This, DWORD grfHLNF, LPBC pbc, IBindStatusCallback* pibsc, IHlink* pihlNavigate);


static HRESULT IEServer_IServiceProvider_QueryService(IHTMLWindow2* This, REFGUID guidService, REFIID riid, void** ppvObject);
...
static const GUID IID_IOleCommandTarget = {0xB722BCCB, 0x4E68, 0x101B, {0xA2, 0xBC, 0x00, 0xAA, 0x00, 0x40, 0x47, 0x70}};

// {0002DF01-0000-0000-C000-000000000046}
static const GUID CLSID_InternetExplorer = {0x0002DF01, 0x0000, 0x0000, {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};

// {B2C867E6-69D6-46F2-A611-DED9A4BD7FEF}
static const GUID IID_ITargetFramePriv2 = {0xB2C867E6, 0x69D6, 0x46F2, {0xA6, 0x11, 0xDE, 0xD9, 0xA4, 0xBD, 0x7F, 0xEF}};

// {000214D0-0000-0000-C000-000000000046}
static const GUID CGID_Explorer = {0x000214D0, 0x0000, 0x0000, {0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46}};
...
{
	if (IsEqualIID(riid, &IID_IUnknown) || IsEqualIID(riid, &IID_IOleCommandTarget) || IsEqualIID(riid, &IID_ITargetFramePriv) || IsEqualIID(riid, &IID_ITargetFramePriv2) || IsEqualIID(riid, &IID_IWebBrowserApp) || IsEqualIID(riid, &IID_IWebBrowser2) || IsEqualIID(riid, &IID_ITargetFrame2) || IsEqualIID(riid, &IID_IHlinkFrame) || IsEqualIID(riid, &IID_IServiceProvider) || 0)
	{
...
_FX IMyUnknown* IEServer_MyCreateInstanceHelper(void)
{
	...
	SizeofVtbls = 0 + sizeof(ULONG_PTR) + sizeof(IOleCommandTargetVtbl) + sizeof(ULONG_PTR) + sizeof(ITargetFramePriv2Vtbl) + sizeof(ULONG_PTR) + sizeof(IWebBrowser2Vtbl) + sizeof(ULONG_PTR) + sizeof(ITargetFrame2Vtbl) + sizeof(ULONG_PTR) + sizeof(IHlinkFrameVtbl) + sizeof(ULONG_PTR) + sizeof(IServiceProviderVtbl) + sizeof(ULONG_PTR) + sizeof(IHTMLWindow2Vtbl);
...
_FX void* IEServer_MyQueryInterface(IMyUnknown* This, REFIID riid)
{
	...
	if (IsEqualIID(riid, &IID_ITargetFramePriv) || IsEqualIID(riid, &IID_ITargetFramePriv2))
	{
		return (void*)&This->Vtbls[2];
	}

	if (IsEqualIID(riid, &IID_IWebBrowserApp) || IsEqualIID(riid, &IID_IWebBrowser2))
	{
...
_FX HRESULT IEServer_IOleCommandTarget_QueryStatus(IOleCommandTarget* This, const GUID* pguidCmdGroup, ULONG cCmds, OLECMD prgCmds[], OLECMDTEXT* pCmdText)
{
...
_FX HRESULT IEServer_IOleCommandTarget_Exec(IOleCommandTarget* This, const GUID* pguidCmdGroup, DWORD nCmdID, DWORD nCmdexecopt, VARIANT* pvaIn, VARIANT* pvaOut)
{
	WCHAR txt[128];
...
_FX HRESULT IEServer_ITargetFramePriv_FindFrameDownwards(ITargetFramePriv* This, LPCWSTR pszTargetName, DWORD dwFlags, IUnknown** ppunkTargetFrame)
{
...
_FX HRESULT IEServer_ITargetFramePriv_FindFrameInContext(ITargetFramePriv* This, LPCWSTR pszTargetName, IUnknown* punkContextFrame, DWORD dwFlags, IUnknown** ppunkTargetFrame)
{
#ifdef COMSERVER_DEBUG
...
_FX HRESULT IEServer_ITargetFramePriv_OnChildFrameActivate(ITargetFramePriv* This, IUnknown* pUnkChildFrame)
{
#ifdef COMSERVER_DEBUG
...
_FX HRESULT IEServer_ITargetFramePriv_OnChildFrameDeactivate(ITargetFramePriv* This, IUnknown* pUnkChildFrame)
{
#ifdef COMSERVER_DEBUG
...
_FX HRESULT IEServer_ITargetFramePriv_NavigateHack(ITargetFramePriv* This, DWORD grfHLNF, LPBC pbc, IBindStatusCallback* pibsc, LPCWSTR pszTargetName, LPCWSTR pszUrl, LPCWSTR pszLocation)
{
#ifdef COMSERVER_DEBUG
	...
	if (pszLocation)
	{
		ULONG len  = (wcslen(pszUrl) + wcslen(pszLocation) + 4) * sizeof(WCHAR);
...
_FX HRESULT IEServer_ITargetFramePriv_FindBrowserByIndex(ITargetFramePriv* This, DWORD dwID, IUnknown** ppunkBrowser)
{
#ifdef COMSERVER_DEBUG
...
_FX HRESULT IEServer_ITargetFramePriv2_AggregatedNavigation2(ITargetFramePriv2* This, DWORD grfHLNF, LPBC pbc, IBindStatusCallback* pibsc, LPCWSTR pszTargetName, IUri* pUri, LPCWSTR pszLocation)
{
	HRESULT hr;
	BSTR pszUrl;
#ifdef COMSERVER_DEBUG
	...
	if (SUCCEEDED(hr))
	{
		hr = ITargetFramePriv2_NavigateHack(This, grfHLNF, pbc, pibsc, pszTargetName, pszUrl, pszLocation);
	}
	return hr;
}
...
_FX HRESULT IEServer_IWebBrowser2_Navigate(IWebBrowser2* This, BSTR url, VARIANT* Flags, VARIANT* TargetFrameName, VARIANT* PostData, VARIANT* Headers)
{
...
_FX HRESULT IEServer_IWebBrowser2_Navigate2(IWebBrowser2* This, VARIANT* URL, VARIANT* Flags, VARIANT* TargetFrameName, VARIANT* PostData, VARIANT* Headers)
{
...
_FX HRESULT IEServer_ITargetFrame2_SetFrameName(ITargetFrame2* This, LPCWSTR pszFrameName)
{
	return S_OK;
}
...
_FX HRESULT IEServer_ITargetFrame2_SetFrameSrc(ITargetFrame2* This, LPCWSTR pszFrameSrc)
{
...
_FX HRESULT IEServer_IHlinkFrame_Navigate(IHlinkFrame* This, DWORD grfHLNF, LPBC pbc, IBindStatusCallback* pibsc, IHlink* pihlNavigate)
{
#ifdef COMSERVER_DEBUG
	WCHAR txt[128];
	...
	if (pihlNavigate)
	{
		...
		HRESULT hr = IHlink_GetStringReference(pihlNavigate, HLINKGETREF_ABSOLUTE, &tgt, &loc);
		if (SUCCEEDED(hr) && tgt)
		{
			len = wcslen(tgt) + 4;
			if (loc)
...
_FX HRESULT IEServer_IServiceProvider_QueryService(IHTMLWindow2* This, REFGUID guidService, REFIID riid, void** ppvObject)
{
...
_FX WCHAR* IEServer_ResolveUrl(WCHAR* path)
{
	...
	len = GetPrivateProfileString(L"InternetShortcut", L"URL", L"", buf, INTERNET_MAX_PATH_LENGTH, buf2);
	if (!len)
	{
		return path;
	}
