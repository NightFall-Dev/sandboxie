...
#define BigNum_Assert(bn) \
	if (!bn)              \
	goto finish

#define BigNum_FreeAndSetNull(bn) \
	BigNum_Free(bn);              \
	bn = NULL

#define BigNum_FreeAndSetTo(bn, bnx) \
	BigNum_Free(bn);                 \
	bn = bnx
...
static void BigNum_DivideHelper(BIGNUM Dividend, BIGNUM Divisor, BIGNUM Quotient);
...
_FX BIGNUM BigNum_ShiftLeft(POOL* pool, BIGNUM BigNumA, ULONG Bits, ULONG OrValue)
{
	//
...
_FX BIGNUM BigNum_DivideByInteger(POOL* pool, BIGNUM BigNumA, ULONG Divisor, ULONG* pReminder)
{
	//
...
_FX void BigNum_DivideHelper(BIGNUM Dividend, BIGNUM Divisor, BIGNUM Quotient)
{
	//
...
_FX BIGNUM BigNum_Divide(POOL* pool, BIGNUM Dividend, BIGNUM Divisor, BIGNUM* pReminder)
{
	//
...
_FX BIGNUM BigNum_ModPow(POOL* pool, BIGNUM Base, BIGNUM Exponent, BIGNUM Modulus)
{
	//
